...
namespace FIMSpace.AnimationTools
{
    ...
    public class ADClipSettings_Morphing : IADSettings
    {
        ...
        public static ADClipSettings_Morphing CopyingFrom = null;
        ...
        internal static void PasteValuesTo(ADClipSettings_Morphing from, ADClipSettings_Morphing to)
        {
            ...
            {
                var cpyMorph = from.Morphs[i];
                to.Morphs.Add(new MorphingSet(cpyMorph.Enabled, cpyMorph.MorphName, to.Morphs.Count, cpyMorph.Blend));
                MorphingSet.PasteValuesTo(from.Morphs[i], to.Morphs[to.Morphs.Count-1]);
            }
        }
        ...
        public class MorphingSet : INameAndIndex
        {
            ...
            internal void DrawTopGUI(float animProgr, ADClipSettings_Main main, int i)
            {
                ...
                if (!Foldown)
                {
                    ...
                    AnimationDesignerWindow.DrawSliderProgress(Blend * BlendEvaluation.Evaluate(animProgr), 82, 177, r);
                    GUILayout.Space(5);
                }
