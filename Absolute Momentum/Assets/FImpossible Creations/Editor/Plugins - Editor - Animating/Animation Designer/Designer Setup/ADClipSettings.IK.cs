    ...
    public class ADClipSettings_IK : IADSettings
    {
        ...
        public class IKSet : INameAndIndex
        {
            ...
            internal void DrawTopGUI(string title, float progr)
            {
                ...
                AnimationDesignerWindow.DrawSliderProgress(Blend * BlendEvaluation.Evaluate(progr), 54);
                AnimationDesignerWindow.DrawCurve(ref BlendEvaluation, "Blend Along Clip Time");
                AnimationDesignerWindow.DrawCurveProgress(progr, 153);
            ...
            internal void DrawParamsGUI(float animProgr, ADArmatureLimb limb, ADClipSettings_Main clipMain, AnimationDesignerSave save, ADClipSettings_IK ikSets)
            {
                ...
                if (IKType == EIKType.FootIK && LegMode == ELegMode.Grounding)
                {
                    ...
                    else if (LegGrounding == ELegGroundingView.Processing)
                    {
                        ...
                        AnimationDesignerWindow.DrawCurveProgressOnR(animProgr, 104f, 56f, r);
                ...
                else
                {
                    ...
                    if (ikCoordsFoldout)
                    {
                        ...
                        AnimationDesignerWindow.DrawCurveProgressOnR(animProgr, 124f, 60f, r);
                ...
                if (mainSetFoldout)
                {
                    ...
                    if (mainSetFoldoutExtra)
                    {
                        ...
                        if (clipMain.ElasticnesSettings.Enabled)
                        {
                            ...
                            AnimationDesignerWindow.DrawCurveProgress(progr, 154);
                            GUILayout.Space(4);
            ...
            void DrawIkBasicPositionOffsetsGUI(float progr, ref Vector3 IKPositionOffset, ref float IKPosOffMul, ref AnimationCurve IKPosOffEvaluate, string hintName = "Elbow", float xOff = 0f)
            {
                ...
                int grOff = LegMode == ELegMode.Grounding ? 4 : 0;
                Rect r = AnimationDesignerWindow.DrawSliderProgress(IKPosOffMul * IKPosOffEvaluate.Evaluate(progr), 79, 127);
                AnimationDesignerWindow.DrawCurveProgressOnR(progr, 124f + xOff + grOff, 60f, r);
            ...
            void DrawIkBasicRotationOffsetsGUI(float progr, ref Vector3 IKRotationOffset, ref float IKRotOffMul, ref AnimationCurve IKRotOffEvaluate)
            {
                ...
                int grOff = LegMode == ELegMode.Grounding ? 28 : 0;
                Rect r = AnimationDesignerWindow.DrawSliderProgress(IKRotOffMul * IKRotOffEvaluate.Evaluate(progr), 80, 127);
                AnimationDesignerWindow.DrawCurveProgressOnR(progr, 124f+grOff, 50f, r);
            ...
            internal void GetClipFootAnalyze(AnimationDesignerSave save, ADArmatureLimb limb, AnimationClip clip, ADClipSettings_Main main, float heelTreshold, float toesTreshold, float holdOnGround, bool removeRootMotion)
            {
