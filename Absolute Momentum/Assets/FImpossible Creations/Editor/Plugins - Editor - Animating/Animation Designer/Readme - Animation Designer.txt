...
Version 1.2.5.3.1
- Updated GUI elements positioning
- Override Rotation Modifier: Right mouse button on the 'Angles' for context menu

Version 1.2.5.3
- Added possibility to export clip in custom framerate (under Setup->Additional Settings For Clip foldout)

Version 1.2.5.2
- Added small red line on animation curves fields to easier identify current animation preview time
- Added animation progress value above the time in seconds label (can be helpful for identifying exact time value on the curves)

Version 1.2.5.1
- Fix for bone limbs read when opening saved Design file on the character model

Version 1.2.5.0
- Implemented copy paste support for the custom modules
- Implemented quick copy paste buttons for Morphs and Custom Modules view

Version 1.2.4.9
- Now secondary animator can be positioned and rotated

Version 1.2.4.8
- Fixed issue with humanoid posers modules breaking when switching characters to edit on the scene

Version 1.2.4.7
- Fixed root motion export for models without parent object for the skeleton root object

Version 1.2.4.6
- Added experimental IK modules: Customized Hips Stabilizer and Push Hips On Feet Grounding

Version 1.2.4.5
- Generic animation was sometimes not allowing to export custom root motion when clip wrongly detected root motion in clip, now it's checking if original root motion keys exists
- Auto save is not resetting timer when animation designer window is opened
